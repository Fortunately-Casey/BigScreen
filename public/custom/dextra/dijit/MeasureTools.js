...
define("dextra/dijit/MeasureTools", [
    ...
    "esri/SpatialReference"
             ...
             Draw, Color, Font, Polyline, MarkerSymbol, LineSymbol, TextSymbol, geometryEngine, InfoTemplate,PictureMarkerSymbol,SpatialReference) {
    var measureTools = declare(_WidgetBase, {
        ...
        _initalToolbar: function () {
            ...
            query("#measure-distance").on("click", lang.hitch(this, this._startMeasureDistance));
            query("#measure-area").on("click", lang.hitch(this, this._startMeasureArea));
        },
        ...
        _endMeasureDistance: function (line, endPoint) {
            ...
            //画终点
            var textSymbol = this._createTextSymbol("终点");
            textSymbol.setOffset(0,-20);
            this._measureLayer.add(new Graphic(endPoint, textSymbol));
        },
        //获取测量点的Graphics
        ...
        _calDistance: function (point1, point2) {
            ...
            if (this.defaults.map.spatialReference.isWebMercator() || this.defaults.map.spatialReference.wkid == "4326"|| this.defaults.map.spatialReference.wkid == "4490") {//在web麦卡托投影和WGS84坐标系下的计算方法
                var aa = geometryEngine.geodesicLength(line, "meters");
                return aa;
            } else {//在其他投影坐标系下的计算方法
            var bb = geometryEngine.planarLength(line, "meters");
                return bb;
            }
        },
        ...
        _calArea: function (polygon) {
            ...
            polygon.setSpatialReference(new SpatialReference(4326));
        ...
        _createClearBtn: function (point) {
           ...
           // var clearSymbol = new MarkerSymbol();
            var clearSymbol = new PictureMarkerSymbol('./images/delete.png',16,16);
        ...
        _createTextSymbol: function (text) {
            var fontColor = new Color("#b11800");
            var holoColor = new Color("#fff");
            //var font = new Font("12pt", Font.STYLE_ITALIC, Font.VARIANT_NORMAL, Font.WEIGHT_BOLD, "Courier");
            var font = new Font("12pt", Font.STYLE_NORMAL, Font.VARIANT_NORMAL, Font.WEIGHT_BOLD, "微软雅黑");
